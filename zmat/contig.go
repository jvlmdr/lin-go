...
func (A Contiguous) Vec() zvec.Mutable { return contiguousAsVector(A) }
...
func (x contiguousAsVector) At(i int) complex128     { return x.Elements[i] }
func (x contiguousAsVector) Set(i int, v complex128) { x.Elements[i] = v }

// Returns MutableT(A).
func (A Contiguous) T() Mutable { return MutableT(A) }

// Returns MutableColumn(A).
func (A Contiguous) Col(j int) zvec.Mutable { return MutableCol(A, j) }
